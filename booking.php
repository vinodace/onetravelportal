...
<body>
<section class="flight-search-result-bg pt-5">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
          <!-- Flight Card -->
          <div class="search-form-name mb-3 p-3 border rounded bg-white">
            <div class="row">
              <div class="col-md-9">
                  ...
                  <div class="row align-items-center mb-3">
                    <div class="col-md-3">
                      <div class="d-flex align-items-center justify-content-between mb-2 mb-md-0">
                        ...
                        <span class="flight-price d-block d-md-none">
      ...
      <div class="col-sm-12">
        <form action="confirm-booking.php" method="post">
          ...
          <div class="flight-result-box">
              <h3 class="main-subhding pb-2 mb-0">Passenger Information</h3>
          ...
          <!-- Billing Info -->
          <div class="flight-result-box">
              <h1 class="main-subhding pb-4">Address Information</h1>
              <div class="row">
                  <div class="col-md-4 mb-3">
                    <div class="form-group">
                      <label class="traveller-form-lbl">Address <span class="red">*</span></label><input type="text" name="address1" class="form_field_web2" required>
                    </div>  
                  </div>
                  <!-- <div class="col-md-4 mb-3">
                    <div class="form-group">
          ...
          <div class="text-center mt-3">
              <button type="submit" name="confirm-booking" class="theme-btn bg-success border-success">Proceed to Confirmation</button>
          </div>
        </form>
      </div>
    </div>
