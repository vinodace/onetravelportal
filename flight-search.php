...
$_SESSION['selected_travel_class'] = ucfirst(strtolower($_GET['travel_class'] ?? 'Economy'));
        ...
        <div class="row">
            <div class="page-heading">
                ...
                <ul class="breadcrumb-list">
                    ...
                    <li class="active">Fligth Search</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="flightsidebar_filter-box_web2 pb-2 sticky-sidebar">
          <div class="flightsidebar_padding_web2">
            <div class="d-flex justify-content-between">
                ...
                <button id="clearFilters" class="clear-filter-btn">Clear Filters</button>
            </div>    
                  ...
                  <?php foreach ($results["dictionaries"]["carriers"] as $code => $name): ?>
                      ...
                      <li>
                          ...
                          <label for="<?= $checkboxId ?>">
                              <img src="https://static.tripcdn.com/packages/flight/airline-logo/latest/airline_logo/3x/<?= strtolower($code) ?>.webp" class="filter-airline-logo" alt="<?= $name ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 d-lg-flex flex-column justify-content-center text-center">
                        <div class="d-flex d-mb-block flex-column justify-content-between justify-content-md-center text-md-center">
                            ...
                            <a href="booking.php?offerId=<?= urlencode($offer['id']) ?>&adults=<?= $adults ?>&children=<?= $children ?>&infants=<?= $infants ?>&travel_class=<?= urlencode($travel_class) ?>" class="theme-btn mt-0">Select</a>
                        </div>
                  ...
                  <div class="modal-body">
                    <?php foreach ($offer['itineraries'] as $iIndex => $itinerary): ?>
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        ...
                        ?>
                        <p class="main-subhding mb-0 pb-2"><small>Duration: <?= $durationFormatted ?></small></p>
                      </div>  
        ...
        <?php
            ...
            if ($count > $limit): ?>
                <div class="text-center mt-3">
                    <button id="showMoreBtn" class="theme-btn bg-warning border-warning text-dark">Show More Flights</button>
                </div>
            <?php endif;
        else: ?>
            <div class="col-sm-12 col-md-12 mb-5" id="waiting-loader">
                <div class="pt-5 flightsidebar_filter-box_web2">
                  ...
                  <img src="assets/img/loader.gif" alt="loader" class="search-form-loader mt-4">
                  <h2 class="wait-hding">Please Wait...</h2>
                  ...
                  <a href="tel:<?= htmlspecialchars($phone_number_web3 ?? '') ?>" class="search-form-callbtn"><i class="fa-solid fa-phone-volume"></i> Call Us <?= htmlspecialchars($phone_number_web3 ?? '') ?></a>
                </div>
            </div>
        <?php endif; ?>
      </div>
...
<div class="modal fade airline-modal-design" id="airline-modal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <a href="tel:<?php echo $phone_number_us; ?>" data-bs-dismiss="modal" class="modal-close">&times;</a>  
      ...
      <div class="modal-body">
        ...
        <div class="d-flex justify-content-center align-items-md-center gap-4 pb-3">
          <div class="w-50">
            <h1 class="modal-search-form-name text-center"><?php echo $origin_name; ?> <br> (<?php echo $origin; ?>) </h1>
          </div>  
          <h1 class="modal-search-form-icon text-center"> <i class="fa-solid fa-arrow-right-long"></i></h1>
          <div class="w-50">
            <h1 class="modal-search-form-name text-center"><?php echo $destination_name; ?> <br> (<?php echo $destination; ?>)</h1>
          </div>  
        </div>
        <div class="modal-deal-box">
          <div class="row">
            <div class="col-md-8">
              <h3 class="modal-deal-name"><?php echo $destination; ?></h3>
              <p class="modal-deal-text"><?php echo $passenger_summary; ?></p>
            ...
            <div class="col-md-4">
              <div class="modal-price-deal">
                ...
                <h3 class="text-danger">$260<sup>*</sup></h3>
        ...
        <p class="modal-note">*Note: All displayed prices are based on searches made in the last 24 hours and are subject to change. Fares are not guaranteed until the ticket is issued.</p>
      </div>
    </div>
  </div>
</div>
...
<script>
  ...
  let timeLeft = 3 * 60; // 5 minutes in seconds
