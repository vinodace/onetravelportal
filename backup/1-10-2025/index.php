    ...
    <section class="hero-section bg-cover" style="background-image: url(assets/img/hero/slider-1.jpg);">
        ...
        <div class="container">
            ...
            <div class="hero-bottom">
                <form id="flightForm" class="flight-searc-box_web2" action="flight-search.php"  method="POST">
                    <div class="row">
                      <div class="col-sm-12">
                              ...
                              <div class="row">
                                <div class="col-sm-6 col-md-6 pe-md-0">
                                  <div class="form-group" id="citySection">
                                    ...
                                    <input type="text" name="from" class="flight-search-field flight-search-field-first" id="fromAirport" placeholder="From" required>
                                ...
                                <div class="col-sm-6 col-md-6 px-md-0">
                                  <div class="form-group" id="citySection">
                                    ...
                                    <input type="text" name="to" class="flight-search-field" id="toAirport" placeholder="To" required>
                            ...
                            <div class="col-sm-6 col-md-2 px-md-0">
                              <div class="form-group">
                                 <label class="flight-search-lbl">Departure</label>
                                  <input type="text" class="flight-search-field field-radius-0_web2 depdate" id="departDate" name="departDate" placeholder="Date" required>
                              </div>
                            </div>
                            <div class="col-sm-6 col-md-2 px-md-0">
                              <div class="form-group">   
                                  <label class="flight-search-lbl">Return</label> 
                                  <input type="text" class="flight-search-field field-radius-0_web2" name="returnDate" id="returnDate" placeholder="Date">
                              </div>
                            </div>
